...
package com.example.shortwriting.data.source.local;

import android.support.annotation.NonNull;
import android.support.annotation.VisibleForTesting;


import com.example.shortwriting.data.Task;
import com.example.shortwriting.data.source.TasksDataSource;
import com.example.shortwriting.util.AppExecutors;
